...
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { rst }]; #IO_L24N_T3_34 Sch=sw[8]
...
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { cf }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
